...
namespace SAVAHHArent.VIews
{
    ...
    public partial class ConfirmSalePage : ContentPage
    {
        ...
        private async void ConfirmButton_Clicked(object sender, EventArgs e)
        {
            ...
            bool result = await DisplayAlert("Необходимо заплатить:", CostLabel.Text, "Yes", "No");
            if (result)
            {
                ...
                await DisplayAlert("Внимание", "Вы оплатили покупку.", "OK");
                connection.Close();
                ...
                await DisplayAlert("Готово", "Вы купили автомобиль!", "OK");
                connection4.Close();
